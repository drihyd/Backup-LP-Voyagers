...
$(window).resize(function() {
	grid_adjust();
	if (($("#mqCheck-500").is(':visible')) || (facultySliderLoaded == false)) {
        func_initFacultySlider();
    }
...
var grid_adjust = function() {
    // if ($("#mqCheck-500").is(":visible")) {
         //$(".grid .item .item-wrapper .item-inner").css("height", "auto");
        var i = [];
        $(".grid .item .item-wrapper .item-inner").each(function() {
            var e = $(this).outerHeight();
            i.push(e)
        });
        var e = (i = i.sort(function(i, e) {
            return e - i
        }))[0];
        $(".grid .item .item-wrapper .item-inner").css("height", e + "px")
    } 
    // else $(".grid .item .item-wrapper .item-inner").css("height", "auto")
// };
...
function func_initFacultySlider() {
    if (!$("#mqCheck-500").is(':visible')) {
        ...
        $('.business-slider,.associate-slider').slick('unslick');
