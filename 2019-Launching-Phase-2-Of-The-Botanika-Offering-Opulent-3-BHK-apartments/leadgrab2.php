...
<head>
	...
	<body style="font-family:Arial, sans-serif;font-size:13px;color:#000;background: #f4f4f4;line-height:1.5;padding: 30px;">
		...
		<p style="text-align:center;"><a href="https://botanika.in/l/2019-Launching-Phase-2-Of-The-Botanika-Offering-Opulent-3-BHK-apartments/pdf/Botanika-Floor-Plans.pdf" style="padding:5px 35px;color:#fff;
